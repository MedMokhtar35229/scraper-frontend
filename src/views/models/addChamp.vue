                ...
                <div class="col-md-6 col-12 mx-auto">
                  <div id="auth-left">
                    ...
                    <form @submit.prevent="submit(champ)">
                      ...
                      <button
                        class="btn btn-primary shadow-lg form-control mb-4"
                      >
                        Sauvé
                      </button>
                      <button
                        class="btn btn-secondary shadow-lg form-control"
...
export default {
  setup() {
    ...
    const champ = reactive({
      id_modele: parseInt(route.params.id.toString()),
      name: "",
      contenu: "",
    });
    const submit = async (champ) => {
      const { data, status } = await axios.post("champ", champ);
      if (status == 200) {
